...
app.controller("EventIndexController", ['$scope', "$controller" , function($scope, $controller){
	...
	$scope.gridModel.columnDefs = [	{field: 'show', enableFiltering: false, width: 65, cellTemplate: '<a class="btn btn-info" role="button" ng-href="show.php?id={{row.entity.id}}">Show</a>'},
