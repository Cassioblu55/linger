<head>
	<meta name="author" content="Cassio Hudson">
	<meta name="keywords" content="Oak Forest, martini, bar, drinks, live music, drink, Linger, dance">
	<meta name="description" content="<?php echo (isset($description)) ? $description : $defaultDescription;  ?>">
	<title><?php echo (isset($title)) ? $title : $defaultTitle; ?></title>
	...
	<script src="<?php echo $baseURL;?>resources/moment/min/moment.min.js"></script>
